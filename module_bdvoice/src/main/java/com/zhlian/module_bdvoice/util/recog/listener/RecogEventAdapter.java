package com.zhlian.module_bdvoice.util.recog.listener;
...
//        Log.i(TAG, logMessage);
        ...
        if (name.equals(SpeechConstant.CALLBACK_EVENT_ASR_LOADED)) {
            ...
            if (data.length != length) {
                com.orhanobut.logger.Logger.e(TAG, "internal error: asr.audio callback data length is not equal to length param");
            }
